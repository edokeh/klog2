define(function(require, exports, module) {
    ...
    m.run(['$templateCache', function($templateCache) {
        $templateCache.put('template/modal/backdrop.html', require('./template/modal/backdrop.html'));
        $templateCache.put('template/modal/window.html', require('./template/modal/window.html'));
    }]);
